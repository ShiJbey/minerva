...
N_PERSONALITY_TRAITS_FROM_PARENTS = 2
INFLUENCE_POINTS_MAX = 10_000
INFLUENCE_POINTS_BASE = 100
CHARACTER_MOTIVE_MAX = 100
CHARACTER_MOTIVE_BASE = 50

BEHAVIOR_UTILITY_THRESHOLD = 0.01
BEHAVIOR_SELECTION_STRATEGY: str = "max"
